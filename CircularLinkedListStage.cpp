...
bool CircularLinkedListStage::processEvents() {
	sf::Event event;
...
void CircularLinkedListStage::update(sf::Time deltaT) {
	ds.update(deltaT);
	stageUpdate(deltaT);
}

void CircularLinkedListStage::render() {
...
void CircularLinkedListStage::run() {
	sf::Clock mClock;
