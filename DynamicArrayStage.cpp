...
DynamicArrayStage::DynamicArrayStage(sf::RenderWindow& window, double radius, double outlineSize, double lineThickness,
	ColorTheme theme, EdgeType edgeType, int numPointCircle) :
	Stage(window, { "Create", "Allocate", "Insert", "Delete", "Search", "Update", "Access" },
		{
...
std::pair<bool, ColorTheme> DynamicArrayStage::processEvents() {
	...
	if (operating) {
		...
		if (operationName[curOperation] == "Allocate") {
