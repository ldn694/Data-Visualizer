...
IngameSettings::IngameSettings(double _x, double _y, double _width, double _height, DataStructure* _ds) :
	...
	themeChoices(_x, _y + _height * 1 / 3, _width / 2, _height * 2 / 3, {"Light Theme", "Dark Theme"}, font(fontType::Arial), 0),
	speedChoices(_x + _width * 0.5, _y + _height * 1 / 3, _width / 2, _height * 2 / 3, { "x0.25", "x0.5", "x1.0", "x2.0", "x4.0" }, font(fontType::Arial), 2)
{
